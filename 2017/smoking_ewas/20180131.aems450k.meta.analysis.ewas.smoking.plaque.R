...
library(devtools)
install_github("molepi/DNAmArray", force = TRUE)
library(DNAmArray)
install_github("molepi/omicsPrint", ref = "R3.4", force = TRUE)
library(omicsPrint)
install_github("bbmri-nl/BBMRIomics", subdir = "BBMRIomics", force = TRUE)
library(BBMRIomics)
...
cat("===========================================================================================")
cat("\n[ META-ANALYSIS of EPIGENOME-WIDE ASSOCIATION STUDY on SMOKING in PLAQUE in AEMS450K1 & 2 ]")
...
pdf(paste0(QC_loc,"/",Today,".aems450k.cohorts.smoking.plaque.EffectSizeDistributions.pdf"),
...
# plaque *with* hospital
pdf(paste0(QC_loc,"/",Today,".aems450k.cohorts.traces.smoking.plaque.pdf"),
    width = 10, height = 10, onefile = TRUE)
  traces(aems450k.meta.bcp.th)
dev.off()
pdf(paste0(QC_loc,"/",Today,".aems450k.cohorts.posteriors.smoking.plaque.pdf"),
    width = 10, height = 10, onefile = TRUE)
  posteriors(aems450k.meta.bcp.th)
dev.off()
pdf(paste0(QC_loc,"/",Today,".aems450k.cohorts.fittedbacon.smoking.plaque.pdf"),
    width = 10, height = 10, onefile = TRUE)
  fit(aems450k.meta.bcp.th, n = 100) # visualization of the fitting using the Gibbs Sampling algorithm
dev.off()
pdf(paste0(QC_loc,"/",Today,".aems450k.cohorts.histogram.smoking.plaque.pdf"),
    width = 10, height = 10, onefile = TRUE)
  print(plot(aems450k.meta.bcp.th, type = "hist"))
dev.off()
pdf(paste0(QC_loc,"/",Today,".aems450k.cohorts.qq.smoking.plaque.pdf"),
    width = 10, height = 10, onefile = TRUE)
...
pdf(paste0(QC_loc,"/",Today,".aems450k.meta.qq.smoking.plaque.pdf"),
    width = 12, height = 12, onefile = TRUE)
  print(plot(aems450k.meta.bcpm.bh, type = "qq"))
dev.off()
png(paste0(QC_loc,"/",Today,".aems450k.meta.qq.smoking.plaque.png"),
...
cat("\n* Plotting...")
cat("\n  - QQ-plot in plaque...")
png(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.QQPlot.png"),
    width = 1024, height = 800)
pdf(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.QQPlot.pdf"),
    width = 12, height = 10, onefile = TRUE)
postscript(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.QQPlot.ps"),
...
png(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.ManhattanPlot.png"),
    width = 1920, height = 1080)
pdf(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.ManhattanPlot.pdf"),
    width = 28, height = 8, onefile = TRUE)
postscript(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.ManhattanPlot.ps"),
...
cat("\n* Plotting...")
cat("\n  - QQ-plot in plaque...")
png(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.QQPlot.replicated.png"),
    width = 1024, height = 800)
pdf(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.QQPlot.replicated.pdf"),
    width = 12, height = 10, onefile = TRUE)
postscript(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.QQPlot.replicated.ps"),
           width = 12, height = 10, onefile = TRUE, bg = "transparent", family = "Helvetica")
  par(mfrow = c(1,2), oma = c(0, 0, 2, 0))
...
png(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.ManhattanPlot.replicated.png"),
    width = 1920, height = 1080)
pdf(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.ManhattanPlot.replicated.pdf"),
    width = 28, height = 8, onefile = TRUE)
postscript(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.ManhattanPlot.replicated.ps"),
           width = 28, height = 10, onefile = TRUE, bg = "transparent", family = "Helvetica")
  par(mfrow = c(1,1), oma = c(0, 0, 0, 0), mai = c(1, 1, 1, 0))
...
cat("\n  > in plaque...")
pdf(paste0(PLOT_loc,"/",Today,".aems450k.meta.smoking.plaque.TopCor.pdf"))
  top.data <- aems450k.meta.resultspfCGIQC[order(aems450k.meta.resultspfCGIQC$PvalCor.meta), ][1,]
...
pdf(paste0(PLOT_loc,"/",Today,".aems450k1.smoking.plaque.Top4.pdf"), paper = "a4r",
    width = 12, height = 8)
