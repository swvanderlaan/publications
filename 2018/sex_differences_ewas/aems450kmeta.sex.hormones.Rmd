...
#### Background
We performed an _epigenome-wide association study_ (EWAS) of autosomal sex-differences using data from the [Athero-Express Biobank Study](http://www.atheroexpress.nl). Previously we published an [EWAS on tobacco smoking](https://www.ahajournals.org/doi/10.1161/CIRCGEN.117.002030) using plaque-derived _DNA methylation_ (DNAm) as measured using the [Illumina Human Methylation 450K BeadArray](https://www.ncbi.nlm.nih.gov/pubmed/22126295). 
